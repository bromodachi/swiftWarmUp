...
class WhackSlot: SKNode {
    ...
    func show(hideTime hideTime:Double) { //forces explicitly call the parameter
        
        if visible { //we don't want to show penguins that are visible
            return
        }
    ...
    func hit () {
        ...
        let notVisible = SKAction.runBlock{
            [unowned self] in self.visible = false
        }
